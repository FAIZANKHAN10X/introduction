...
import { animateHero } from "../animations/sections/hero";

export default function Hero() {
  const rootRef = useSectionAnimation<HTMLElement>(animateHero);
        ...
        <div className="space-y-8">
          <div className="font-serif leading-none tracking-tighter">
            <h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl text-text-primary"
            >
              Faizan Khan
            </h1>
            <h2
          ...
          <p
            data-anim="hero-copy"
            className="max-w-2xl text-lg md:text-xl font-mono text-text-primary/80 leading-relaxed"
          >
          ...
          <div data-anim="hero-cta" className="flex flex-wrap gap-4 pt-4">
            <Link
              to="/booking"
