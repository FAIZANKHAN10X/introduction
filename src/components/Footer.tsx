...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-bg-dark py-20 sm:py-24">
      {/* Ambient overlays */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 sm:mt-14">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-bg-dark/70 p-5 sm:p-6 shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 font-mono text-sm text-text-primary/55">
                ...
                <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.22em] text-white/40">
                  <span className="h-2 w-2 rounded-full bg-accent shadow-[0_0_10px_rgba(163,117,65,0.35)]" />
                  ONLINE
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 border-t border-white/10 pt-10 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-6">
              <div className="select-none flex h-16 w-12 flex-col items-center justify-center border-2 border-white/15 bg-bg-dark font-mono text-[10px] leading-none text-text-primary">
                <span className="pt-1">DEV</span>
                <span className="text-xl font-black text-accent/60">26</span>
              </div>
